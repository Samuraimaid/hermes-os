...
Siguiente paso: catálogo de artículos en back office, o reembolso. No inventario ni factura fiscal.
...
| `backend/app/` | API |
| `frontend/src/App.jsx` | Hub (TPV, turno, kiosco, `/cds`, `/kds`, `/ventas`) · moneda C$ |
